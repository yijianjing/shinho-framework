package com.shinho.framework.common.config;

import com.shinho.framework.base.config.Config;
import com.shinho.framework.base.utils.ConfigUtils;
...
public class SpringConfig implements Config, BeanFactoryPostProcessor {
    ...
    public static final String NAME = "com.shinho.framework.common.config.SpringConfig";
    /** 默认排序 **/
