...
import com.shinho.framework.base.utils.ObjectUtils;
import com.shinho.framework.base.utils.ResourceUtils;
...
public class AreaCodeUtils {
    ...
    public static Address findAddressByCode(String code){
        ...
        if( !code.endsWith(CODE) ){
            ...
            address.setDistrict(findNameByCode(address.getCode()));
        }
        return address;
    }
