...
import com.shinho.framework.base.BusinessException;
import com.shinho.framework.base.BusinessRuntimeException;
...
public final class Response<T> implements Serializable {
    ...
    public static <T> Response<T> failure(Exception exception){
        ...
        if( exception instanceof IllegalArgumentException){
            return failure(message , PARAMETER_ERROR_CODE);
        }
