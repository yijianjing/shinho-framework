...
public final class SpecificationComposite implements ISpecification {
    ...
    @Override
    public SpecificationComposite not(boolean isNew) {
    ...
    public SpecificationComposite distinct(){
        return distinct(true);
    }

    public SpecificationComposite notDistinct(){
        return distinct(false);
    }

    public SpecificationComposite distinct(boolean distinct){
