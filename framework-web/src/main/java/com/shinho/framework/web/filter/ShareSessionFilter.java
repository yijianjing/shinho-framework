package com.shinho.framework.web.filter;

import com.google.common.base.Strings;
import com.shinho.framework.base.store.Store;
import com.shinho.framework.web.MockStroe;
import com.shinho.framework.web.request.ShareSessionRequest;
import com.shinho.framework.web.session.ShareSession;
...
public class ShareSessionFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        //获取缓存实现类
        //RedisStore.class
        Class<?> cacheClass =(Class<?>)findConfigValue(filterConfig, configCacheKey, MockStroe.class);
