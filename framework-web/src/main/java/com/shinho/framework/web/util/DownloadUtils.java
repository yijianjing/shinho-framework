...
import com.shinho.framework.base.utils.ImgUtils;
import com.shinho.framework.base.utils.IoUtils;
...
public class DownloadUtils {
    ...
    public static HttpServletResponse download(byte [] bytes, String fileName, HttpServletRequest request, HttpServletResponse response) {

        return download(new ByteArrayInputStream(bytes),fileName, request, response ,null);
    }
